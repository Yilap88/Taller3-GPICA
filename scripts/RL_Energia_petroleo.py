...
plt.savefig('resultados/03_RL_Energia_petroleo_grafica.png', format="png", bbox_inches="tight", dpi=300)
...
# Guardar la tabla como un archivo .png
plt.savefig('resultados/03_RL_Energia_petroleo_evaluacion.png', format="png", bbox_inches="tight", dpi=300)
