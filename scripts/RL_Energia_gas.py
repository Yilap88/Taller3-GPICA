...
plt.savefig('resultados/01_RL_Energia_gas_grafica.png', format="png", bbox_inches="tight", dpi=300)
...
# Guardar la tabla como un archivo .png
plt.savefig('resultados/01_RL_Energia_gas_evaluacion.png', format="png", bbox_inches="tight", dpi=300)
