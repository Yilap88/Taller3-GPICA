...
plt.savefig('resultados/02_RL_Energia_carbon_grafica.png', format="png", bbox_inches="tight", dpi=300)
...
# Guardar la tabla como un archivo .png
plt.savefig('resultados/02_RL_Energia_carbon_evaluacion.png', format="png", bbox_inches="tight", dpi=300)
